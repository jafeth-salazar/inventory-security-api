...
-- Supervisores (lectura y escritura)
CREATE LOGIN inv_supervisor1 WITH PASSWORD = 'ChangeMe_Supervisor1_2026!', CHECK_POLICY = ON;
CREATE LOGIN inv_supervisor2 WITH PASSWORD = 'ChangeMe_Supervisor2_2026!', CHECK_POLICY = ON;
CREATE LOGIN inv_supervisor3 WITH PASSWORD = 'ChangeMe_Supervisor3_2026!', CHECK_POLICY = ON;
...
CREATE USER inv_supervisor1 FOR LOGIN inv_supervisor1;
CREATE USER inv_supervisor2 FOR LOGIN inv_supervisor2;
CREATE USER inv_supervisor3 FOR LOGIN inv_supervisor3;
...
ALTER ROLE db_supervisor_rol ADD MEMBER inv_supervisor1;
ALTER ROLE db_supervisor_rol ADD MEMBER inv_supervisor2;
ALTER ROLE db_supervisor_rol ADD MEMBER inv_supervisor3;
